...
export const SKINS: readonly Skin[] = [
  ...
  { name: 'Corsair', hull: '#e8dcf5', accent: '#8e44ad', cockpit: '#5b2c6f', bullet: '#e39bff', bulletGlow: '#bb3cff', bulletShape: 'orb', damageBonus: 2 },
  { name: 'Tempest', hull: '#d6e9f7', accent: '#1f6f9b', cockpit: '#12455f', bullet: '#8fe9ff', bulletGlow: '#00b7ff', bulletShape: 'wave', damageBonus: 3 },
  { name: 'Warden', hull: '#f7e7c8', accent: '#d68910', cockpit: '#7e5109', bullet: '#ffd86b', bulletGlow: '#ff9f1a', bulletShape: 'star', damageBonus: 4 },
  { name: 'Ascendant', hull: '#fbe4ea', accent: '#c0392b', cockpit: '#7b241c', bullet: '#ff8d7a', bulletGlow: '#ff3b1f', bulletShape: 'star', damageBonus: 6 },
];
